          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center" data-aos="zoom-y-out" data-aos-delay="300">
                ...
                <div>
                  <a className="flex justify-between items-center bg-green-600 hover:bg-green-700 text-white mx-2 py-2 px-4 rounded w-full sm:w-auto" href="https://api.whatsapp.com/send?phone=558296612000&text=Ol%C3%A1%2C%20gostaria%20de%20agendar%20uma%20aula%20experimental" target="_blank">
